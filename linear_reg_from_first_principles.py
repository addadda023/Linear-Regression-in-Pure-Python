...
class TestLinearRegression(unittest.TestCase):
    ...
    def setUp(self):
        self.model = LinearRegression(batch_size=2, num_features=4)
    ...
    def test_get_weights_before_training(self):
        ...
        self.assertEqual(len(model_weights), 4)
    ...
    def test_training_loop(self):
        ...
        for index in range(150):
            pred, loss = self.model.train(features=self.features_batch, labels=self.labels, learning_rate=0.005)
